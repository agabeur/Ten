//
//  SDUFriendMapListViewController.m
//  Ten
//
...
#import "SDUFriendRestMapListViewController.h"
#import "SDURest.h"
#import "SDUFriendRestDetailViewController.h"

@interface SDUFriendRestMapListViewController ()

@end

@implementation SDUFriendRestMapListViewController
...
{
    static NSString *CellIdentifier = @"friendRestCell";
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"RestDetailSegue"]) {
        SDUFriendRestDetailViewController *restDetailViewController = segue.destinationViewController;
